...
public class RockSampleObservationState extends RockSampleState implements MutableOOState {
    ...
    // set
    // Given a variable key and a value, sets the value of the object
    // corresponding to the key and returns
    @Override
    ...
    // object
    // If object name matches object in domain, return that object. Return
    // null otherwise
    @Override
    ...
    public MutableOOState addObject(ObjectInstance o){
        if(o instanceof RoverAgent
                || o.className().equals(RockSample.CLASS_ROVER)){
            touchRover();
            rover = (RoverAgent) o;
        }else if(o instanceof RockSampleRock
                || o.className().equals(RockSample.CLASS_ROCK)){
            touchRocks().put(o.name(), (RockSampleRock) o);
        }else if(o instanceof RockSampleWall
                || o.className().equals(RockSample.CLASS_WALL)){
