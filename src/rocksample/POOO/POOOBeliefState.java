 ...
 * <p>
 * If using a BeliefMDP solver with a {@link POOOBeliefState},
...
public class POOOBeliefState implements OOState, BeliefState, EnumerableBeliefState, DenseBeliefVector, MutableState, HashableState{
    ...
    public POOOBeliefState(POOODomain domain){
        if(!domain.providesStateEnumerator()){
            throw new RuntimeException("POOOBeliefState(POOODomain domain) constructor requires that" +
                    "the POOODomain provides a StateEnumerator, but it does not. Alternatively consider using the" +
                    "POOOBeliefState(POOODomain domain, StateEnumerator stateEnumerator), where you can" +
    ...
    /**
     * Constructs a new {@link POOOBeliefState}.
     ...
     */
    public POOOBeliefState(POOODomain domain, StateEnumerator stateEnumerator){
        this.domain = domain;
    ...
    public MutableState set(Object variableKey, Object value) {
        ...
        if(variableKey instanceof Integer){
            ...
            try{
                ...
                throw new RuntimeException("Could not set belief for POOOBeliefState because the key is a String, but does not parse into an int; it is " + variableKey);
            }
        }
        else{
            throw new RuntimeException("Cannot set belief for POOOBeliefState because they is a " + variableKey.getClass().getName() + " rather than a, Integer, State, or String representation of an int");
        }
    ...
    public boolean equals(Object obj) {
        ...
        if(!(obj instanceof POOOBeliefState)){
            return false;
        }

        POOOBeliefState otb = (POOOBeliefState)obj;
